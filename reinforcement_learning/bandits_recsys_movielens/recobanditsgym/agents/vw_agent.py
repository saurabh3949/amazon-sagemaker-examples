...
class VWAgent:
    def __init__(self,
        ...
        if model_path:
            ...
            # Apply iteractions if training for the first time only. VW saves the q parameter.
    ...
    def learn(self, user_embedding, candidate_embeddings, action_index, action_prob,
        ...
        if candidate_embeddings is not None:
            item_vw_features = [self.transform_context(i, start_index) for i in candidate_embeddings]
    ...
    def choose_actions(self, user_embedding, candidate_embeddings,
        ...
        for k in range(top_k_actions):
            ...
            parsed_example = self.generate_prediction_string_multiline(shared_vw_features,
